...
if (initialUsers.length === 0) {
  ...
  const seedChallenges: ProblemChallenge[] = [
    ...
    },
    {
      ...
      title: 'Python Lists & Loops: Even Squares Sum',
    ...
    },
    {
      ...
      title: 'Python Logic: Fibonacci Series Generator',
      description: 'Generate an array containing the first \'n\' numbers of the Fibonacci sequence using an iterative loop. If n <= 0, return an empty array. If n === 1, return [0].',
      difficulty: 'Medium',
    ...
    },
    {
      ...
      title: 'Database: Simulated INNER JOIN Operator',
    ...
    },
    {
      ...
      title: 'Database: Group-By & SUM Aggregation',
    ...
    },
    {
      ...
      description: 'Write a function to perform matrix multiplication on two 2x2 matrices represented as 2D arrays of numbers. Return the resulting 2x2 matrix as a 2D array.',
      difficulty: 'Medium',
    ...
    },
    {
      ...
      title: 'Math: Vector Dot Product Calculator',
    ...
    },
    {
      ...
      title: 'Writing Analyzer: Word & Sentence Count',
      description: 'To evaluate the readability score of technical texts, write a text analyzer that returns the count of words and count of sentences in a given paragraphs string. A word is any space-separated sequence, and a sentence ends with a period, exclamation mark, or question mark.',
      difficulty: 'Easy',
